...
import msong.{TrackSectionAnalysisLocal, TrackSectionAnalysis, Analysis}
...
/**
  ...
  */
@Test
class TrackSectionAnalysisLocalTest {
  ...
  def findSimilarSectionsTest(): Unit = {
    ...
    try {
      ...
      val trackAnalysis = new TrackSectionAnalysisLocal(track)
